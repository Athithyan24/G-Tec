                    ...
                    <div className="p-4">
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-medium bg-gray-50 px-2 py-1 rounded-md border border-gray-100 text-gray-800">
                            100%
                          </span>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 bg-gray-50 p-1.5 rounded-md border border-gray-100">
                            ...
                            <span className="font-medium uppercase flex-1 text-gray-800 tracking-wide text-[11px]">
                              #8B5CF6
                            </span>
