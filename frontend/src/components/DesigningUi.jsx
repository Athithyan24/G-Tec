...
export default function DesignTestimonial() {
  const testimonials = [
    ...
    },
    {
      ...
      quote: "\"This tool has completely transformed our team's workflow. The real-time editing and seamless integration make everything so much smoother!\"",
      name: "Emily Ray",
      role: "UX Designer"
    },
    {
  ...
  return (
    <>
    <section className="w-full bg-white pt-24 px-6 md:px-12 lg:px-24 font-sans overflow-hidden">
      ...
      <motion.div 
        ...
        className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start"
      >
        <div>
          <h2 className="text-4xl md:text-5xl lg:text-[3.5rem] leading-tight font-clash tracking-tight text-gray-900">
            Loved by designers & <br className="hidden lg:block" /> teams
          </h2>
        </div>
