...
const stackIcons = [
  // Top Row (MERN)
  { id: 'mongo1', x: 10, y: 10, icon: "/mdb.png", name: "MongoDB", bg: "bg-emerald-900", delay: 0 },
  { id: 'express1', x: 33.3, y: 10, icon: "/Express.png", name: "Express.js", bg: "bg-slate-700", delay: 0.1 },
  { id: 'react', x: 56.6, y: 10, icon: "/React.png", name: "React.js", bg: "bg-slate-900", delay: 0.2 },
  { id: 'node1', x: 80, y: 10, icon: "/Node.js.png", name: "Node.js", bg: "bg-green-900", delay: 0.3 },
  
  // Middle Row (MEAN)
  { id: 'mongo2', x: 10, y: 35, icon: "/mdb.png", name: "MongoDB", bg: "bg-emerald-900", delay: 0.4 },
  { id: 'express2', x: 33.3, y: 35, icon: "/Express.png", name: "Express.js", bg: "bg-slate-700", delay: 0.5 },
  { id: 'angular', x: 56.6, y: 35, icon: "/Angular.png", name: "Angular.js", bg: "bg-orange-800", delay: 0.6 },
  { id: 'node2', x: 80, y: 35, icon: "/Node.js.png", name: "Node.js", bg: "bg-green-900", delay: 0.7 },
];
...
const WebDevSpecial = () => {
  ...
  const leftX = useTransform(scrollYProgress, [0, 0.35, 0.65, 1], [-300, 0, 0, -300]);
  const leftOpacity = useTransform(scrollYProgress, [0, 0.35, 0.65, 1], [0, 1, 1, 0]);

  // RIGHT PANEL SCRUBBING:
  // Starts off-screen right (300px), stops at center (0px), then leaves right (300px)
  const rightX = useTransform(scrollYProgress, [0, 0.35, 0.65, 1], [300, 0, 0, 300]);
  const rightOpacity = useTransform(scrollYProgress, [0, 0.35, 0.65, 1], [0, 1, 1, 0]);

  return (
    <section ref={sectionRef} className="w-full bg-white py-10 px-6 md:px-12 overflow-hidden">
          ...
          <div className="relative w-full aspect-square md:aspect-4/4 rounded-4xl mb-15">
            ...
            {stackIcons.map((item) => (
              <motion.div
                ...
                title={item.name}
              >
                <img src={item.icon} alt={item.name} className="w-10 h-full object-contain rotate-315" />
              </motion.div>
            ))}
            ...
            >
              <img src="/vite.png" alt="Vite Logo" className="w-full h-full object-contain relative z-10" />
  ...
  unlimited potential.
          ...
          <p className="text-black text-sm md:text-md leading-relaxed mb-10 max-w-lg">
            Empower your coding journey by mastering both the <strong>MERN</strong> and <strong>MEAN</strong> stacks. Bring your ideas to life—seamlessly and effortlessly—powered by the blazing fast Vite build tool.
          </p>
          ...
          <div className="flex items-center gap-4 pt-8 border-t border-gray-100 w-full max-w-md">
            ...
            <div className="flex flex-col">
              <span className="text-sm italic text-gray-600 mb-1">
                "Our platform unifies the best tech stacks so you can build scalable enterprise apps."
              </span>
