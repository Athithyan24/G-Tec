...
export default function StudentsTab() {
  ...
  const filteredStudents = students.filter((s) =>
    ...
    (s.courseCategory && s.courseCategory.toLowerCase().includes(searchTerm.toLowerCase()))
  );
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <div className="relative group">
            ...
            <input 
              type="text" 
              placeholder="Search by name, category, or course..."
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50/50 border-b border-gray-100">
                  ...
                  <th className="p-5 text-xs font-bold text-gray-400 uppercase">Specific Course</th>
                  ...
                  >
                    ...
                    <td className="p-5 text-sm">
                      <div className="flex flex-col gap-1">
                        <span className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-lg font-bold border border-indigo-100 text-[11px] w-fit uppercase">
                          {student.courseCategory ? student.courseCategory.replace('-', ' ') : "N/A"}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="p-5 text-sm">
                      <div className="flex flex-col gap-1">
                        <span className="px-3 py-1 bg-gray-50 text-gray-700 rounded-lg font-bold border border-gray-200 text-[11px] w-fit">
                          +{student.phone}
                        </span>
                      </div>
                    </td>
